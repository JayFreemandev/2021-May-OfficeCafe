...
<link href="${root}/resources/css/editor.css" rel="stylesheet" type="text/css">
</head>
...
<body>
					...
					<div class="ask-question-input-part032">
						...
						<form role="form" action="/board/register" method="post">
							...
							<div class="question-title39">
								...
								<input type="text" name="board_title" class="question-ttile32" placeholder="Write Your Question Title">
							</div>

							<div class="categori49">
								<span class="form-description43305">카테고리 </span> <label> <input list="browsers" name="myBrowser" class="list-category53" /></label>
							...
							<div class="details2-239">
								<div class="col-md-12 nopadding">
									<textarea id="txtEditor" name='board_contents'></textarea>
								</div>
							</div>
				...
				<aside class="col-md-3 sidebar97239">
					...
					<div class="login-part2389">
						...
						<div class="rememberme">
							<label><input type="checkbox" checked="checked"> Remember Me</label> <a href="#" class="resbutton3892">Register</a>
						</div>
					</div>
					<!--              highest part-->
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="info-part-two320">
						<h4>Quick Links</h4>
						<a href="#"><p>-Home</p></a> <a href="#"><p>-Ask Question</p></a> <a href="#"><p>-Questions</p></a> <a href="#"><p>-Users</p></a> <a href="#"><p>-Edit Profile</p></a> <a href="#"><p>-Page</p></a> <a href="#"><p>-Contact Us</p></a> <a href="#"><p>-Buy now</p></a>
					</div>
				</div>
				<div class="col-md-3">
	...
	<script src="${root}/resources/js/editor.js"></script>
	<script>
