		...
		<div id="middlebox" class="col">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-heading">
						글목록
						<button id='regBtn' type="button" class="btn btn-primary float-right">글쓰기</button>
					</div>
				</div>
				<!-- /.panel-heading -->
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<c:forEach items="${list}" var="board">
							<tr>
								...
								<td class="td_like">
									<c:out value="${board.board_read}" />
								</td>

								<td class="td_date">
									<fmt:formatDate pattern="yyyy-MM-dd" value="${board.board_created_date}" />
								</td>
							</tr>
						</c:forEach>
					</table>
